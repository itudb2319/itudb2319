CREATE TABLE IF NOT EXISTS drivers(
	driverId INT DEFAULT unique_rowid(),
...
CREATE TABLE IF NOT EXISTS constructors(
	constructorId INT DEFAULT unique_rowid(),
...
CREATE TABLE IF NOT EXISTS circuits(
	circuitId INT DEFAULT unique_rowid(),
...
CREATE TABLE IF NOT EXISTS races(
	raceId INT DEFAULT unique_rowid(),
	year INT,
	round INT,
	circuitId INT,
	name VARCHAR(255),
...
qualifyId INT DEFAULT unique_rowid(),
raceId INT,
driverId INT,
constructorId INT,
number INT,
...
CREATE TABLE IF NOT EXISTS status (
	statusId INT DEFAULT unique_rowid(),
	status VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS sprintResults(
	sprintResultId INT DEFAULT unique_rowid(),
	raceId INT,
	driverId INT,
	constructorId INT,
	number INT,
...
CREATE TABLE IF NOT EXISTS results(
	resultId INT DEFAULT unique_rowid(),
	raceId INT,
	driverId INT,
	constructorId INT,
	number INT,
...
CREATE TABLE IF NOT EXISTS driverStandings (
	driverStandingsId INT DEFAULT unique_rowid(),
	raceId INT,
	driverId INT,
	points DECIMAL,
	position INT,
...
CREATE TABLE IF NOT EXISTS constructorStandings(
	constructorStandingsId INT DEFAULT unique_rowid(),
	raceId INT,
	constructorId INT,
	points DECIMAL,
	position INT,
...
CREATE TABLE IF NOT EXISTS constructorResults(
	constructorResultsId INT DEFAULT unique_rowid(),
	raceId INT,
	constructorId INT,
	points DECIMAL,
	status VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS quiz (
	quizId INT DEFAULT unique_rowid(),
...
CREATE TABLE IF NOT EXISTS users(
	userId INT DEFAULT unique_rowid(),
